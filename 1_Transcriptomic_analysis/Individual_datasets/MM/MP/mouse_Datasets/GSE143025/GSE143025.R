...
setwd("W:/PhD/Projects/MM Pain-Bone/Computation/Cells/MP/mDatasets MP/GSE143025")
...
# probe id annotation
require(mogene20sttranscriptcluster.db)
...
eset_rma_unfiltered_annotated <- annotated(exprs(eset_rma),anotPackage="mogene20sttranscriptcluster.db")
...
class <- data.frame("#CLASS","HD","HD","HD","MM","MM","MM") 
...
# probe id annotation
eset_rma_filtered.id_annotated<-annotated(exprs(eset_filtered.id),anotPackage="mogene20sttranscriptcluster.db")
...
topAnnotated_MMvsHD.id <- annotatedTopTable(topTab_MMvsHD.id,anotPackage="mogene20sttranscriptcluster.db")
...
# probe id annotation
eset_rma_filtered.id.var_annotated<-annotated(exprs(eset_filtered.id.var),anotPackage="mogene20sttranscriptcluster.db")
...
# probe id annotation
topAnnotated_MMvsHD.id.var <- annotatedTopTable(topTab_MMvsHD.id.var,anotPackage="mogene20sttranscriptcluster.db")
