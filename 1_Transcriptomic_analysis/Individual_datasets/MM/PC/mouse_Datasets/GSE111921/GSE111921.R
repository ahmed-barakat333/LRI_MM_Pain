...
setwd("~/Work/PhD/Projects/MoD_TrD_LRI_MMPain/Computational_Analysis/Ligand_Receptor/Data/MM/PC/mDatasets/GSE111921")
...
eset_rma_unfiltered_annotated <- annotated(exprs(eset_rma),anotPackage="mouse4302.db")
...
# probe id annotation
eset_rma_filtered.id_annotated<-annotated(exprs(eset_filtered.id),anotPackage="mouse4302.db")
...
topAnnotated_MMvsHD.id <- annotatedTopTable(topTab_MMvsHD.id,anotPackage="mouse4302.db")
...
# probe id annotation
eset_rma_filtered.id.var_annotated<-annotated(exprs(eset_filtered.id.var),anotPackage="mouse4302.db")
...
# probe id annotation
topAnnotated_MMvsHD.id.var <- annotatedTopTable(topTab_MMvsHD.id.var,anotPackage="mouse4302.db")
