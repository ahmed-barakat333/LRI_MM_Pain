...
## load data
pc_pathways <- read.csv("results_pathway_enrichment/PC_Pathways.csv")
...
bmsc_pathways <- read.csv("results_pathway_enrichment/BMSC_Pathways.csv")
...
ec_pathways <- read.csv("results_pathway_enrichment/EC_Pathways.csv")
...
ocy_pathways <- read.csv("results_pathway_enrichment/OCY_Pathways.csv")
...
opc_pathways <- read.csv("results_pathway_enrichment/opc_Pathways.csv")
...
adcy_pathways <- read.csv("results_pathway_enrichment/ADCY_Pathways.csv")
...
nkc_pathways <- read.csv("results_pathway_enrichment/NKC_Pathways.csv")
...
neut_pathways <- read.csv("results_pathway_enrichment/NEUT_Pathways.csv")
...
mp_pathways <- read.csv("results_pathway_enrichment/MP_Pathways.csv")
...
treg_pathways <- read.csv("results_pathway_enrichment/Treg_Pathways.csv")
...
hsc_pathways <- read.csv("results_pathway_enrichment/HSC_Pathways.csv")
...
wbm_pathways <- read.csv("results_pathway_enrichment/WBM_Pathways.csv")
...
save(pathways.gom.obj, file = "results_pathway_enrichment/pathways.gom.obj.RData")
load("results_pathway_enrichment/pathways.gom.obj.RData")
...
#tiff("results_overlap/pathways_dot_plot.tiff", units="in", width=14, height=13, res=100)
...
tiff("results_overlap/pathways_dot_plot.tiff", units="in", width=7, height=6, res=300)
...
tiff("results_overlap/pathways_dendo_plot.tiff", units="in", width=8, height=7, res=300)
...
## load data
pc_kinases <- read.csv("results_x2k/kinases/PC_Kinases.csv")
...
#write.csv(pc_kinases,"results_x2k/kinases/PC_kinases.csv", row.names = FALSE)
pc_kinases <- as.vector(pc_kinases)


bmsc_kinases <- read.csv("results_x2k/kinases/BMSC_Kinases.csv")
...
#write.csv(bmsc_kinases,"results_x2k/kinases/bmsc_kinases.csv", row.names = FALSE)
bmsc_kinases <- as.vector(bmsc_kinases)


ec_kinases <- read.csv("results_x2k/kinases/EC_Kinases.csv")
...
#write.csv(ec_kinases,"results_x2k/kinases/ec_kinases.csv", row.names = FALSE)
ec_kinases <- as.vector(ec_kinases)

ocy_kinases <- read.csv("results_x2k/kinases/OCY_Kinases.csv")
...
#write.csv(ocy_kinases,"results_x2k/kinases/ocy_kinases.csv", row.names = FALSE)
ocy_kinases <- as.vector(ocy_kinases)

nkc_kinases <- read.csv("results_x2k/kinases/NKC_Kinases.csv")
...
#write.csv(nkc_kinases,"results_x2k/kinases/nkc_kinases.csv", row.names = FALSE)
...
save(kinases.gom.obj, file = "results_x2k/kinases/kinases.gom.obj.RData")
load("results_x2k/kinases/kinases.gom.obj.RData")
...
#tiff("results_overlap/kinases_dot_plot.tiff", units="in", width=12, height=10, res=100)
...
## plot overlap
tiff("results_overlap/kinases_dot_plot.tiff", units="in", width=8, height=7, res=100)
...
tiff("results_overlap/kinases_dendo_plot.tiff", units="in", width=8, height=7, res=100)
ggplot(data$segments) + 
  geom_segment(aes(x = x, y = y, xend = xend, yend = yend),size=0.5)+
  geom_text(data = data$labels, aes(x, y, label = label), hjust = -0.03, angle = 0, size = 4, fontface=1) +
  coord_flip() + 
...
# adcy_kinases <- read.csv("results_x2k/kinases/adcy_Kinases.csv")
...
mp_kinases <- read.csv("results_x2k/kinases/MP_kinases.csv")
...
treg_kinases <- read.csv("results_x2k/kinases/treg_kinases.csv")
...
wbm_kinases <- read.csv("results_x2k/kinases/wbm_kinases.csv")
...
tiff("results_overlap/cells_kinases_dot_plot.tiff", units="in", width=8, height=15, res=100)
...
## load data
pc_tf <- read.csv("results_x2k/tf/PC_tf.csv")
...
pc_tf <- pc_tf[1]
#write.csv(pc_tf,"results_x2k/tf/PC_tf.csv", row.names = FALSE)
pc_tf <- as.vector(pc_tf)


bmsc_tf <- read.csv("results_x2k/tf/BMSC_tf.csv")
...
bmsc_tf <- bmsc_tf[1]
#write.csv(bmsc_tf,"results_x2k/tf/bmsc_tf.csv", row.names = FALSE)
bmsc_tf <- as.vector(bmsc_tf)


ec_tf <- read.csv("results_x2k/tf/EC_tf.csv")
...
ec_tf <- ec_tf[1]
#write.csv(ec_tf,"results_x2k/tf/ec_tf.csv", row.names = FALSE)
ec_tf <- as.vector(ec_tf)

ocy_tf <- read.csv("results_x2k/tf/OCY_tf.csv")
...
ocy_tf <- ocy_tf[1]
#write.csv(ocy_tf,"results_x2k/tf/ocy_tf.csv", row.names = FALSE)
ocy_tf <- as.vector(ocy_tf)

nkc_tf <- read.csv("results_x2k/tf/NKC_tf.csv")
...
nkc_tf <- nkc_tf[1]
#write.csv(nkc_tf,"results_x2k/tf/nkc_tf.csv", row.names = FALSE)
...
save(tf.gom.obj, file = "results_x2k/tf/tf.gom.obj.RData")
load("results_x2k/tf/tf.gom.obj.RData")
...
#tiff("results_overlap/tf_dot_plot.tiff", units="in", width=12, height=10, res=100)
...
## plot overlap
tiff("results_overlap/tf_dot_plot.tiff", units="in", width=8, height=7, res=100)
...
tiff("results_overlap/tf_dendo_plot.tiff", units="in", width=8, height=7, res=100)
ggplot(data$segments) + 
  geom_segment(aes(x = x, y = y, xend = xend, yend = yend),size=0.5)+
  geom_text(data = data$labels, aes(x, y, label = label), hjust = -0.03, angle = 0, size = 4, fontface=1) +
  coord_flip() + 
...
# adcy_tf <- read.csv("results_x2k/tf/adcy_tf.csv")
...
mp_tf <- read.csv("results_x2k/tf/MP_tf.csv")
...
treg_tf <- read.csv("results_x2k/tf/treg_tf.csv")
...
wbm_tf <- read.csv("results_x2k/tf/wbm_tf.csv")
...
tiff("results_overlap/cells_tf_dot_plot.tiff", units="in", width=8, height=7.25, res=100)
...
tiff("results_overlap/cells_kinases_tf_plot.tiff", units="in", width=10, height=15, res=300)
...
saveRDS(cells_kinases_tf_plot, file="results_overlap/cells_kinases_tf_plot.RData")

cells_kinases_tf_plot <- readRDS("results_overlap/cells_kinases_tf_plot.RData")
cells_kinases_tf_plot
