...
write_csv(pc_pathways,"results_pathway_enrichment/PC_Pathways.csv")
...
write_csv(bmsc_pathways,"results_pathway_enrichment/BMSC_Pathways.csv")
#_________________________________________________________________________________________________
#_________________________________________________________________________________________________
...
write_csv(ec_pathways,"results_pathway_enrichment/EC_Pathways.csv")
#_________________________________________________________________________________________________
#_________________________________________________________________________________________________
...
write_csv(ocy_pathways,"results_pathway_enrichment/OCY_Pathways.csv")
...
write_csv(opc_pathways,"results_pathway_enrichment/OPC_Pathways.csv")
...
write_csv(adcy_pathways,"results_pathway_enrichment/ADCY_Pathways.csv")
...
write_csv(nkc_pathways,"results_pathway_enrichment/NKC_Pathways.csv")
...
write_csv(neut_pathways,"results_pathway_enrichment/NEUT_Pathways.csv")
...
write_csv(mp_pathways,"results_pathway_enrichment/MP_Pathways.csv")
...
write_csv(treg_pathways,"results_pathway_enrichment/Treg_Pathways.csv")
...
write_csv(hsc_pathways,"results_pathway_enrichment/HSC_Pathways.csv")
...
write_csv(wbm_pathways,"results_pathway_enrichment/WBM_Pathways.csv")
...
tiff("results_pathway_enrichment/kegg_plot_2.tiff", units="in", width=8, height=8, res=100)
kegg_plot
dev.off()
...
tiff("results_pathway_enrichment/kegg_plot.tiff", units="in", width=8, height=8, res=100)
kegg_plot
dev.off()
...
tiff("results_pathway_enrichment/reactome_plot_2.tiff", units="in", width=8, height=8, res=100)
reactome_plot
dev.off()
...
tiff("results_pathway_enrichment/reactome_plot.tiff", units="in", width=8, height=8, res=100)
reactome_plot
dev.off()
...
tiff("results_pathway_enrichment/wikiPathways_plot_2.tiff", units="in", width=8, height=8, res=100)
wikiPathways_plot
dev.off()
...
tiff("results_pathway_enrichment/wikiPathways_plot.tiff", units="in", width=8, height=8, res=100)
wikiPathways_plot
dev.off()
#_________________________________________________________________________________________________
#_________________________________________________________________________________________________
...
# export figures
tiff("results_pathway_enrichment/heatmap_plot_2.tiff", units="in", width=10, height=12, res=300)
draw(wikiPathways_plot %v% reactome_plot %v% kegg_plot, heatmap_legend_side = "top")
dev.off()


tiff("results_pathway_enrichment/heatmap_plot.tiff", units="in", width=9, height=8, res=300)
...
write_csv(pc_pathways,"results_pathway_enrichment/PC_Pathways_0.001.csv")
...
write_csv(mus_pc_pathways,"results_pathway_enrichment/MUS_PC_Pathways_0.001.csv")
...
tiff("results_pathway_enrichment/hs_mus_pc_kegg_plot_2.tiff", units="in", width=8, height=8, res=100)
hs_mus_pc_kegg_plot
dev.off()
...
tiff("results_pathway_enrichment/hs_mus_pc_kegg_plot.tiff", units="in", width=8, height=8, res=100)
hs_mus_pc_kegg_plot
dev.off()
...
tiff("results_pathway_enrichment/hs_mus_pc_reactome_plot_2.tiff", units="in", width=8, height=15, res=100)
hs_mus_pc_reactome_plot
dev.off()
...
tiff("results_pathway_enrichment/hs_mus_pc_reactome_plot.tiff", units="in", width=30, height=8, res=100)
hs_mus_pc_reactome_plot
dev.off()
...
tiff("results_pathway_enrichment/hs_mus_pc_wikiPathways_plot_2.tiff", units="in", width=8, height=15, res=100)
hs_mus_pc_wikiPathways_plot
dev.off()
...
tiff("results_pathway_enrichment/hs_mus_pc_wikiPathways_plot.tiff", units="in", width=8, height=8, res=100)
hs_mus_pc_wikiPathways_plot
dev.off()
#_________________________________________________________________________________________________
#_________________________________________________________________________________________________
...
tiff("results_pathway_enrichment/hs_mus_pc_heatmap_plot_2.tiff", units="in", width=18, height=20, res=300)
draw(hs_mus_pc_wikiPathways_plot %v% hs_mus_pc_reactome_plot %v% hs_mus_pc_kegg_plot, heatmap_legend_side = "top")
dev.off()

tiff("results_pathway_enrichment/hs_mus_pc_heatmap_plot.tiff", units="in", width=40, height=10, res=300)
