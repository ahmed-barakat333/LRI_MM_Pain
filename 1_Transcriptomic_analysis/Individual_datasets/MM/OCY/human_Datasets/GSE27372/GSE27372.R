...
setwd("W:/PhD/Projects/BMSC Bone/Systems BMSC Bone/Systems BMSC MM/Analysis-MA Systems BMSC MM/GSE36474")
...
class <- data.frame("#CLASS","HD","HD","HD","MM","MM","MM") 
names(class) <- names(eset_rma_filtered.id_annotated)
...
class <- data.frame("#CLASS","HD","HD","HD","MM","MM","MM") 
names(class) <- names(eset_rma_filtered.id.var_annotated)
