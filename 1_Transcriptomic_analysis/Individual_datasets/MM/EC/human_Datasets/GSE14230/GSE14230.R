...
setwd("W:/PhD/Projects/MM Pain/Computation MM TME/Datasets EC/GSE14230")
...
# probe id annotation
require(hgu133a.db)
annotation(eset_rma) <- "hgu133a.db"
...
eset_rma_unfiltered_annotated <- annotated(exprs(eset_rma),anotPackage="hgu133a.db")
...
names(class)<-names(eset_rma_unfiltered_annotated)
...
# probe id annotation
eset_rma_filtered.id_annotated<-annotated(exprs(eset_filtered.id),anotPackage="hgu133a.db")
...
topAnnotated_MMvsHD.id <- annotatedTopTable(topTab_MMvsHD.id,anotPackage="hgu133a.db")
...
# probe id annotation
eset_rma_filtered.id.var_annotated<-annotated(exprs(eset_filtered.id.var),anotPackage="hgu133a.db")
...
# probe id annotation
topAnnotated_MMvsHD.id.var <- annotatedTopTable(topTab_MMvsHD.id.var,anotPackage="hgu133a.db")
