...
setwd("W:/PhD/Projects/BMSC Bone/Systems BMSC Bone/Systems BMSC MM/Analysis-MA Systems BMSC MM/GSE78235")
...
class <- data.frame("#CLASS","HD","HD","HD","HD","MM","MM") 
names(class) <- c("ENTREZID","GSM2070024_LONZA_MSC_young_1.CEL","GSM2070025_LONZA_MSC_young_2.CEL","GSM2070026_LONZA_MSC_old_1.CEL","GSM2070027_LONZA_MSC_old_2.CEL","GSM2070028_MM_MSC_1.CEL","GSM2070029_MM_MSC_2.CEL")
eset_rma_unfiltered_annotated <- rbind(class,eset_rma_unfiltered_annotated)
colnames(eset_rma_unfiltered_annotated) <- c("#NAME","GSM2070024_LONZA_MSC_young_1.CEL","GSM2070025_LONZA_MSC_young_2.CEL","GSM2070026_LONZA_MSC_old_1.CEL","GSM2070027_LONZA_MSC_old_2.CEL","GSM2070028_MM_MSC_1.CEL","GSM2070029_MM_MSC_2.CEL")
...
colnames(eset_rma_filtered.id_annotated) <- c("#NAME","GSM2070024_LONZA_MSC_young_1.CEL","GSM2070025_LONZA_MSC_young_2.CEL","GSM2070026_LONZA_MSC_old_1.CEL","GSM2070027_LONZA_MSC_old_2.CEL","GSM2070028_MM_MSC_1.CEL","GSM2070029_MM_MSC_2.CEL")
...
colnames(eset_rma_filtered.id.var_annotated) <- c("#NAME","GSM2070024_LONZA_MSC_young_1.CEL","GSM2070025_LONZA_MSC_young_2.CEL","GSM2070026_LONZA_MSC_old_1.CEL","GSM2070027_LONZA_MSC_old_2.CEL","GSM2070028_MM_MSC_1.CEL","GSM2070029_MM_MSC_2.CEL")
