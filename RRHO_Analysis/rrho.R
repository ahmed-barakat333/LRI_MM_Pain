...
tiff("results/pc_plot.tiff", units="in", width=10, height=50, res=300)
...
tiff("results/bmsc_plot.tiff", units="in", width=10, height=50, res=300)
...
tiff("results/ec_plot.tiff", units="in", width=10, height=50, res=300)
...
tiff("results/rrho_plot.tiff", units="in", width=35, height=35, res=300)
...
tiff("results/pc_plot_sign.tiff", units="in", width=20, height=7, res=100)
pc_plot
dev.off()
...
tiff("results/human_mouse_pc_plot.tiff", units="in", width=8, height=7, res=100)
hs_mus_pc_plot
dev.off()
